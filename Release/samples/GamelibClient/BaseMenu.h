...
public:
    ...
    void SetHeading(const char* pchHeading) { m_sHeading = pchHeading; }
    ...
    void AddMenuItem(MenuItem_t item) { m_VecMenuItems.push_back(item); }
    ...
    void RunFrame()
    {
            ...
            m_pGameEngine->BIsControllerActionActive(eControllerDigitalAction_MenuSelect))
        {
            ...
            if (ulCurrentTickCount - 220 > g_ulLastReturnKeyTick)
            {
                ...
                {
                    GameClient()->OnMenuSelection(m_VecMenuItems[m_uSelectedItem].second);
                    return;
                }
            }
        }
    ...
    virtual void Render()
    {
        ...
        if (m_sHeading.length())
        {
            ...
            m_pGameEngine->BDrawString(
                g_hMenuFont, rectHeader, dwColor, TEXTPOS_CENTER | TEXTPOS_VCENTER, m_sHeading.c_str());
        }
        ...
        if (iStartItem > 0)
        {
            ...
            m_pGameEngine->BDrawString(
                g_hMenuFont, rect, dwColor, TEXTPOS_CENTER | TEXTPOS_VCENTER, "... Scroll Up ...");
        ...
        if (iNumItems > iEndItem)
        {
            ...
            DWORD dwColor = D3DCOLOR_ARGB(255, 255, 255, 255);
            m_pGameEngine->BDrawString(
                g_hMenuFont, rect, dwColor, TEXTPOS_CENTER | TEXTPOS_VCENTER, "... Scroll Down ...");
